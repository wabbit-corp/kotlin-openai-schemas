...
// managed-integrity-v1: gEkof2fQoaB
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-openai-schemas", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-openai-schemas")
        description.set("Kotlin Multiplatform helpers for deriving OpenAI function-tool schemas from kotlinx.serialization descriptors.")
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-openai-schemas"
