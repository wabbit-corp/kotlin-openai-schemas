...
publishing {
    publications {
        create<MavenPublication>("maven") {
            groupId = "one.wabbit"
            artifactId = "kotlin-openai-schemas"
            version = "0.1.0"
...
dependencies {
    implementation(project(":kotlin-data-ref")) // 1.1.1
...
kover {
    ...
    //             // title.set("kotlin-openai-schemas Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-openai-schemas/tree/master/src/main/kotlin")
